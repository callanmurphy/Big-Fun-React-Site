const users = [
  {id: 0, name: 'admin', password: 'admin', online: false, profilePic: 0, rivals: [1,2,3,4], status: 'Offline', rivalGames: [{rid: 1, date: "2021-05-24T15:30"}, {rid: 2, date: "2021-05-24T16:30"}]},
